...
| **WIT (`///wit`)**       | [`wit`](https://github.com/wcodesoft/please-rules/tree/wit)       | [`[WIT] v0.3.0`](https://github.com/wcodesoft/please-rules/releases/tag/wit-v0.3.0)       | [WIT Rules](https://github.com/wcodesoft/please-rules/tree/wit)                                           | WebAssembly Interface Types (WIT) bundling and binding generators for Swift, Kotlin, Rust, Go, TS, C++, and Python. |
