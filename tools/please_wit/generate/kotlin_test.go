...
`,
		...
		{
			name:     "resource with methods and constructor",
			baseName: "structures",
			pkg: &ast.Package{
				Namespace: "babel",
				Name:      "structures",
						...
						Resources: []ast.Resource{
							{
								...
								Methods: []ast.Function{
									{
										Name:   "make-set",
										Params: []ast.Param{{Name: "x", Type: &ast.TypeRef{Kind: ast.KindPrimitive, Name: "s32"}}},
									},
									{
										Name:    "find",
										Params:  []ast.Param{{Name: "x", Type: &ast.TypeRef{Kind: ast.KindPrimitive, Name: "s32"}}},
										Results: &ast.TypeRef{Kind: ast.KindOption, TypeArgs: []*ast.TypeRef{{Kind: ast.KindPrimitive, Name: "s32"}}},
									},
									{
										Name: "union",
										Params: []ast.Param{
											{Name: "x", Type: &ast.TypeRef{Kind: ast.KindPrimitive, Name: "s32"}},
											{Name: "y", Type: &ast.TypeRef{Kind: ast.KindPrimitive, Name: "s32"}},
										},
									},
									{
										Name: "is-connected",
										...
										Results: &ast.TypeRef{Kind: ast.KindPrimitive, Name: "bool"},
									},
								},
							},
						},
